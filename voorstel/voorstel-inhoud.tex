...
De maritieme sector wordt steeds meer geconfronteerd met cyberaanvallen, waarbij schepen en hun operationele technologie steeds vaker het doelwit zijn. 
Volgens \textcite{bush2021ethical} zijn cyberaanvallen op de operationele technologie van schepen zijn de afgelopen jaren met maar liefst 900\% gestegen. Ethisch hacker Weston Hecker legt uit hoe 
kwetsbaar veel schepen zijn, zelfs met de vooruitgang in informatiebeveiliging. Aanvallers kunnen vaak gemakkelijk toegang krijgen tot schepen via zwakke plekken, 
zoals onbeschermde draadloze netwerken, printers of zelfs door het lezen van een gebruikershandleiding. Dit toont aan hoe belangrijk het is om werkstations ,zoals de 
nurse-PC goed af te bakenen. Zwakke punten zoals onveilige verbindingen kunnen leiden tot ernstige gevolgen, waaronder het overnemen van systemen die cruciaal zijn 
voor de werking van het schip. Het beschermen van deze netwerken is dus niet alleen een technische uitdaging, maar een noodzakelijke stap om de veiligheid van de 
scheepvaart te waarborgen en de gevolgen van cyberaanvallen te minimaliseren.
...
zoals technische specificaties en foutmeldingen, snel beschikbaar is voor het onderhoudsteam, zodat zij de juiste acties kunnen ondernemen om storingen 
...
Shadow IT verwijst naar onbekende IT-assets die binnen een organisatie worden gebruikt zonder dat deze zijn goedgekeurd of beheerd door de IT-afdeling. 
Dit kan variëren van persoonlijke apparaten tot cloudtechnologieën, zoals het opslaan van bedrijfsgegevens in persoonlijke cloudaccounts. Dergelijke technologieën 
zijn niet in lijn met de interne IT-processen en -beveiligingsmaatregelen van de organisatie, waardoor ze een risico vormen voor de veiligheid van gegevens en systemen. 
Shadow IT kan leiden tot datadiefstal, malwareverspreiding of andere beveiligingsincidenten, omdat deze apparaten of diensten vaak niet voldoen aan de vereiste 
beveiligingsnormen. Hoewel het meestal niet het gevolg is van kwade opzet, ontstaan shadow IT-oplossingen vaak doordat medewerkers officiële tools of processen als 
onvoldoende ervaren om hun werk te doen. Het is belangrijk voor organisaties om deze praktijk te herkennen en te beheren om de risico's te beperken.\autocite{NCSC2024}
